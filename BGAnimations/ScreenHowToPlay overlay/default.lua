return Def.ActorFrame {
	...
	LoadFont("_celestia redux 33px") .. {
		...
		InitCommand=cmd(zbuffer,1;z,20;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;shadowlength,1;strokecolor,Color("Outline");diffuse,PlayerColor(PLAYER_1););
		OnCommand=cmd(skewx,-0.125;shadowlength,2;shadowcolor,BoostColor(color("#ffd40077"),0.25);diffusealpha,0;zoom,4;sleep,0.0;linear,0.3;diffusealpha,1;zoom,1;sleep,1.8;linear,0.3;zoom,0.75;x,170;y,60);
	};
	...
	Def.ActorFrame {
		InitCommand=cmd(x,SCREEN_LEFT+210;y,SCREEN_CENTER_Y+40);
