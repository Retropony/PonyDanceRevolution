...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,left;zoom,0.8;addy,-24;addx,131;);
...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,right;zoom,0.75;addx,170;diffuse,PlayerColor(PLAYER_2););
		  OnCommand=cmd(queuecommand,"Transition";);
		  OffCommand=cmd(decelerate,0.3;diffusealpha,0;addx,10;);
          CurrentStepsP2ChangedMessageCommand=cmd(playcommand,"Set";playcommand,"Transition";); 
		  TransitionCommand=cmd(finishtweening;diffusealpha,0;addy,-3;smooth,0.2;diffusealpha,1;addy,3;);
...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,right;zoom,0.75;addx,170;addy,20;diffuse,PlayerColor(PLAYER_2););
		  OnCommand=cmd(queuecommand,"Transition";);
		  OffCommand=cmd(decelerate,0.3;diffusealpha,0;addx,10;);
          CurrentStepsP2ChangedMessageCommand=cmd(playcommand,"Set";playcommand,"Transition";); 
		  TransitionCommand=cmd(finishtweening;diffusealpha,0;addy,-3;smooth,0.2;diffusealpha,1;addy,3;);
...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,right;zoom,0.75;addx,170;addy,40;diffuse,PlayerColor(PLAYER_2););
		  OnCommand=cmd(queuecommand,"Transition";);
		  OffCommand=cmd(decelerate,0.3;diffusealpha,0;addx,10;);
          CurrentStepsP2ChangedMessageCommand=cmd(playcommand,"Set";playcommand,"Transition";); 
		  TransitionCommand=cmd(finishtweening;diffusealpha,0;addy,-3;smooth,0.2;diffusealpha,1;addy,3;);
...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,right;zoom,0.75;addx,170;addy,60;diffuse,PlayerColor(PLAYER_2););
		  OnCommand=cmd(queuecommand,"Transition";);
		  OffCommand=cmd(decelerate,0.3;diffusealpha,0;addx,10;);
          CurrentStepsP2ChangedMessageCommand=cmd(playcommand,"Set";playcommand,"Transition";); 
		  TransitionCommand=cmd(finishtweening;diffusealpha,0;addy,-3;smooth,0.2;diffusealpha,1;addy,3;);
...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,right;zoom,0.75;addx,170;addy,80;diffuse,PlayerColor(PLAYER_2););
		  OnCommand=cmd(queuecommand,"Transition";);
		  OffCommand=cmd(decelerate,0.3;diffusealpha,0;addx,10;);
          CurrentStepsP2ChangedMessageCommand=cmd(playcommand,"Set";playcommand,"Transition";); 
		  TransitionCommand=cmd(finishtweening;diffusealpha,0;addy,-3;smooth,0.2;diffusealpha,1;addy,3;);
...
t[#t+1] = LoadFont("Common normal") .. { 
		  InitCommand=cmd(horizalign,right;zoom,0.75;addx,170;addy,100;diffuse,PlayerColor(PLAYER_2););
		  OnCommand=cmd(queuecommand,"Transition";);
		  OffCommand=cmd(decelerate,0.3;diffusealpha,0;addx,10;);
          CurrentStepsP2ChangedMessageCommand=cmd(playcommand,"Set";playcommand,"Transition";); 
		  TransitionCommand=cmd(finishtweening;diffusealpha,0;addy,-3;smooth,0.2;diffusealpha,1;addy,3;);
