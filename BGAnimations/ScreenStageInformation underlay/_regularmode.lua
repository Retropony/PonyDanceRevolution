...
t[#t+1] = Def.ActorFrame {
	InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_BOTTOM-42);	
	LoadActor("ScreenStageInformation Stage " .. ToEnumShortString(sStage) ) .. {
		OnCommand=cmd(diffusealpha,0;zoom,0;sleep,1;smooth,1;zoom,0.5;diffusealpha,1;sleep,2;smooth,1;diffusealpha,0;zoom,0;);
	};
};

t[#t+1] = LoadActor("classicmode") .. {
