...
t[#t+1] = LoadActor("stageextra") .. {
		...
		OnCommand=cmd(zoom,1;diffusealpha,0;sleep,3.5;smooth,1;diffusealpha,1;sleep,2.5;smooth,0.5;diffusealpha,0;zoom,0.6;);
	};
...
t[#t+1] = Def.ActorFrame {
		...
		LoadActor("extraglow") .. {
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-100);
		OnCommand=cmd(diffusealpha,0.5;zoomx,-6;zoomy,-4;smooth,1;zoomx,-1;zoomy,-1;sleep,1.5;smooth,0.5;zoomy,1;decelerate,0.5;zoomx,1;sleep,3.5;smooth,0.5;diffusealpha,0;zoom,0.6;);
	};
};
