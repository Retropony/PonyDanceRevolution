...
local pdr3 = {
	...
	"Pony vectors:",
	"90sigma / aethon056 / Ambassad0r",
	"Archive-Alicorn / Austiniousi / BaumkuchenPony",
	"biodegradablebox / Bluetech / Caliazian",
	"Capt-Nemo / CassidyCreations / Checker-Pony",
	"DashieSparkle / DecPrincess / DjDavid98",
	"DragonMaster137 / Durpy / FreddieBox",
	"hunterscars / ispincharles / jeatz-axl",
	"KingDark0001 / koolfrood / kysss90",
	"Kyute-Kitsune / lilcinnamon / Luckreza8",
	"Makintosh91 / missgoldendragon / moongazeponies",
	"NabbieKitty / nano23823 / Paula2003",
	"Ready2Fail / Sairoch / scourge707",
	"Scrimpeh / ShaddyShad / ShellToon",
	"SilverVectors / sircinnamon / SketchMCreations",
	"SolusJBJ / Synch-Anon / TheBossCamacho",
	"Turbo740 / Vector-Brony / Vectorized Unicorn",
	"xxxthehtfgodxx / Yanoda / Zacatron94 / zziccardi",
	};
