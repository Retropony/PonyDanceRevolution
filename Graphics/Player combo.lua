...
-- 			c.Number:playcommand("Miss");
		...
		if param.FullComboW1 then
			c.Number:diffuse(color("#6abacb"));
			c.Number:glowshift();
			c.Label:diffuse(color("#6abacb"));
		elseif param.FullComboW2 then
			c.Number:diffuse(color("#ffc977"));
			c.Number:glowshift();
			c.Label:diffuse(color("#ffc977"));
		elseif param.FullComboW3 then
			c.Number:diffuse(color("#55ff4c"));
			c.Number:stopeffect();
			c.Label:diffuse(color("#55ff4c"));
		elseif param.FullComboW4 then
			c.Number:diffuse(color("#c568fb"));
			c.Number:stopeffect();
			c.Label:diffuse(color("#c568fb"));
