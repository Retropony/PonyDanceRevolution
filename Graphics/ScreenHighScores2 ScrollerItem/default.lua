...
t[#t+1] = Def.Banner{
		InitCommand=cmd(x,-276;halign,0;scaletoclipped,128,40;diffusealpha,0.75;fadeleft,0.25;faderight,0.25);
...
t[#t+1] = LoadFont("Common normal")..{
		InitCommand=cmd(x,-292;y,-1;halign,0;shadowlength,1;maxwidth,260);
		SetCommand=function(self, params)
			if params.Course then
